...
void MainWindow::drawFlag()
{
    ...
    scene->addRect(flagXPos, 0, FLAG_WIDTH, FLAG_PART_HEIGHT, Qt::NoPen, QBrush(QColor("#0073cf")));
    scene->addRect(flagXPos, FLAG_PART_HEIGHT, FLAG_WIDTH, FLAG_PART_HEIGHT, Qt::NoPen, QBrush(Qt::black));
    scene->addRect(flagXPos, FLAG_PART_HEIGHT * 2, FLAG_WIDTH, FLAG_PART_HEIGHT, Qt::NoPen, QBrush(Qt::white));
